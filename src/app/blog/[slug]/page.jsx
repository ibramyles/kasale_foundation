...
const SinglePostPage = () => {
  return (
    <div>
      ...
      <section className='post w-11/12 grid grid-cols-1 lg:grid-cols-4 gap-8 lg:w-9/12 mx-auto border-2 mb-24'>
        <section className='left-post-section grid grid-cols-1 gap-8 lg:grid-cols-2 col-span-3'>
          ...
          <div className='post-info border-2'>
        ...
        <section className='right-post-section border-2'>
          <h3>Recent Posts</h3>
        </section>
      </section>
    </div>
